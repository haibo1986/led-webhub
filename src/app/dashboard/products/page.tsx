...
import { Archive, ChevronRight, Languages, Package, Plus } from "lucide-react";
...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{ deleted?: string }> }) {
  ...
  return <AdminPage title="产品资料" eyebrow="PRODUCT INFORMATION SYSTEM" tenant={session.tenant.name} action={<Link className="primary-action" href="/dashboard/products/new"><Plus/>新增产品</Link>}>
